...
<div class="modal fade" id="tambah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= site_url('admin/home/save_konten') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-outline-secondary btn-rounded btn-icon" data-bs-toggle="modal" data-bs-target="#edit<?= $k->id_konten ?>"><i class="ti-pencil-alt text-primary"></i></button>
                                    <button class="btn btn-outline-secondary btn-rounded btn-icon" data-bs-toggle="modal" data-bs-target="#hapus<?= $k->id_konten ?>"><i class="ti-trash text-danger"></i></button>
                                    <div class="modal fade" id="edit<?= $k->id_konten ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form action="<?= site_url('admin/home/edit_konten/' . $k->id_konten) ?>" method="post" enctype="multipart/form-data">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-floating mb-3">
                                                            <textarea name="isi_konten" class="form-control" type="text" required placeholder="" style="height: 100px"><?= $k->isi_konten ?></textarea>
                                                            <label for="inputKonten">Isi Konten</label>
                                                        </div>
                                                        <div class="form-group mb-3">
                                                            <label for="inputImage" class="form-label">Foto :</label>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="<?= site_url('admin/home/delete_konten/' . $k->id_konten); ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

        ...
        <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <div id="datepicker-popup" class="input-group date datepicker navbar-date-picker bg-white">
                    ...
                    <li class="nav-item dropdown user-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                            <div class="dropdown-header text-center">
                                ...
                                ?>
                                <h5 class="mb-1 mt-3 font-weight-semibold">
                                    <?= $ambil->nama ?>
                                </h5>
                            </div>
        ...
        <div class="container-fluid page-body-wrapper">
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    <li class="nav-item
                    <?php
                    if (current_url() == site_url('kontributor')) {
                        echo " active";
                    }
                    ?>
                    ">
                        <a class="nav-link" href="<?= site_url('kontributor') ?>">
                    ...
                    <li class="nav-item
                    <?php
                    if (current_url() == site_url('kontenk')) {
                        echo " active";
                    }
                    ?>
                    ">
                        <a class="nav-link" href="<?= site_url('kontenk') ?>">
                    ...
                    <li class="nav-item
                    <?php
                    if (current_url() == site_url('_galeri')) {
                        echo " active";
                    }
                    ?>
                    ">
                        <a class="nav-link" href="<?= site_url('_galeri') ?>">
                    ...
                    <li class="nav-item
                    <?php
                    if (current_url() == site_url('show_saran')) {
                        echo " active";
                    }
                    ?>
                    ">
                        <a class="nav-link" href="<?= site_url('show_saran') ?>">

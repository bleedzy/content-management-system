...
<div class="modal fade" id="tambah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= site_url('kontributor/home/save_galeri') ?>" method="post" enctype="multipart/form-data">
...
<div class="row">
    ...
    ?>
        <div class="col-sm-4 mb-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">
                        Upload : <?= DateTime::createFromFormat('Y-m-d', $g->tanggal)->format('d-M-y'); ?><br>
                        Dibuat oleh : <?= $g->username ?>
                    </p>
                    <?php
                    if ($ambil->username == $g->username) {
                        echo '<div>
        ...
        <div class="modal fade" id="edit<?= $g->id_galeri ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="<?= site_url('kontributor/home/edit_galeri/' . $g->id_galeri) ?>" method="post" enctype="multipart/form-data">
                        <div class="modal-header">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="<?= site_url('kontributor/home/delete_galeri/' . $g->id_galeri); ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
                    </div>
                </div>
            </div>
        </div>
